          ...
          <CardContent className="p-8 md:p-12">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-8">
                Join us in cultivating gratitude throughout 2026 with daily journal prompts designed to help you reflect on the moments, people, and experiences that bring joy to your life.
              </p>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2">
                    Sign up for Ink-lings
                  </h3>
                  <p className="text-base text-gray-700 dark:text-gray-300">
                    Create your free account to start receiving gratitude prompts.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2">
                    Select &quot;2026 Gratitude&quot; as a category
                  </h3>
                  <p className="text-base text-gray-700 dark:text-gray-300">
                    Choose the 2026 Gratitude category during onboarding or update your preferences anytime.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-700 dark:text-gray-300">
                    Choose how often you want to receive prompts - daily, weekly, or custom days that work for you.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-700 dark:text-gray-300">
                    Receive prompts in your inbox and take a few minutes each day to reflect and write.
                  </p>
                </div>
              </div>
            </div>
