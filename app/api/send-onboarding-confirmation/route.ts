                  ...
                  <td class="px" style="padding:32px;">
                    ...
                    <div style="margin-bottom:20px; padding:16px; background:#f8f9fa; border-radius:8px;">
                      ...
                      <div style="display:flex; align-items:center; gap:12px;">
                        <img src="https://inklingsjournal.live/notebook_image.jpg" alt="Spiral Notebook" style="width:80px; height:80px; object-fit:cover; border-radius:4px;">
                        <div>
                    ...
                    <div style="margin-bottom:20px; padding:16px; background:#f8f9fa; border-radius:8px;">
                      ...
                      <div style="display:flex; align-items:center; gap:12px;">
                        <img src="https://inklingsjournal.live/pen_holder_image.jpg" alt="Pen Organizer" style="width:80px; height:80px; object-fit:cover; border-radius:4px;">
                        <div>
