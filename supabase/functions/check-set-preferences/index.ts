...
<body style="margin:0; padding:0; background:#f8f9fa !important;">
  ...
  <div style="display:none; max-height:0; overflow:hidden; opacity:0; mso-hide:all;">
    You're not receiving journal prompts yet because we don't know what you want and when.
  </div>
          ...
          <tr>
            <td class="px" style="padding:32px;">
              ...
              <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; color:#475569 !important; font-size:16px; line-height:1.6; margin:0 0 24px;">
                Keep in mind, these prompts don't have to be just for journaling, it could be talking points with the people in your life too! Ink-lings doesn't have to apply to just ink.
              </p>
              
              <!-- Call to Action Button -->
              <div style="text-align:center; margin:32px 0;">
                <a href="https://inklingsjournal.live/" style="background:#007bff !important; color:#ffffff !important; text-decoration:none; padding:16px 32px; border-radius:8px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size:16px; font-weight:600; display:inline-block;">
          ...
          <tr>
            <td class="px" style="padding:32px;">
              <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; color:#64748b !important; font-size:14px; line-height:1.5; margin:0; text-align:center;">
                Ready to start your journaling journey?<br>
                Set your preferences and get your first prompt!<br><br>
                Rachell<br>
