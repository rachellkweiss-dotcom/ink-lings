...
Because showing up — on any page, in any state — builds a record worth having. Real life isn't a string of insights. It's this, too. And there's a small, steady power to writing it down anyway.`,
  },
  {
    ...
    date: 'May 2026',
    summary: 'Cracking open an old journal is one of the strangest things you can do to yourself — equal parts cringe, comfort, and quiet revelation. Here\'s why re-reading your past writing feels so unsettling, and how to do it without getting lost.',
    content: `## The Notebook Behind the Winter Boots
